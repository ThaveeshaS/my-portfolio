...
function App() {
  ...
  return (
    <div className="font-sans bg-black text-white min-h-screen">
      {/* Navigation */}
      <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-black/95 backdrop-blur-md shadow-lg border-b border-gray-800' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center py-3 sm:py-4">
            <div className="flex items-center space-x-2 sm:space-x-3">
              {/* Logo */}
              <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full overflow-hidden shadow-md transition-all duration-300 ${isScrolled ? 'bg-gray-700 scale-95' : 'bg-gray-800'}`}>
                <img
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center hero-content">
          <div className="text-center lg:text-left z-10 order-2 lg:order-1">
            <div className="mb-6 sm:mb-8 flex justify-center lg:justify-start">
              <div className="w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48 mb-4 sm:mb-6 rounded-full overflow-hidden border-4 border-gray-600 shadow-lg profile-image">
                <img
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 mb-3 sm:mb-4 typewriter">Full Stack Developer</p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 sm:gap-6 animate-scale-in px-4 lg:px-0">
              ...
              <div className="flex gap-3 sm:gap-4 justify-center lg:justify-start">
                {/* GitHub */}
                <a href="#" className="social-link w-10 h-10 sm:w-12 sm:h-12 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-900 hover:shadow-lg hover:shadow-gray-500/20 transition-all duration-300 transform hover:scale-110 group">
                ...
                {/* Instagram */}
                <a href="#" className="social-link w-10 h-10 sm:w-12 sm:h-12 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gradient-to-r hover:from-purple-500 hover:via-pink-500 hover:to-orange-500 hover:shadow-lg hover:shadow-pink-500/30 transition-all duration-300 transform hover:scale-110 group">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-300 group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-8 sm:space-y-12">
                {[
                  ...
                  >
                    ...
                    <div className={`md:ml-16 lg:ml-20 bg-gray-900 rounded-xl p-4 sm:p-6 lg:p-8 border border-gray-700 shadow-md hover:shadow-lg transition-all duration-700 ${visibleEducationItems.has(index) ? 'translate-y-0 scale-100' : 'translate-y-5 scale-95'}`}>
